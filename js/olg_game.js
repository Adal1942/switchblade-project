...
let playerXIcon = "fa-solid fa-user-tie";
let playerOIcon = "fa-solid fa-user-secret";
let playerSign = "fa-solid fa-user-tie";
let runBot = true;

function clickedBox(element){
    if(players.classList.contains("players")){
        playerSign = "fa-solid fa-user-secret";
        ...
        playerSign = "fa-solid fa-user-tie";
...
function selectWinner(){
    if(checkClass(1,2,3,playerSign) || checkClass(4,5,6,playerSign) || checkClass(7,8,9,playerSign) || checkClass(1,4,7,playerSign) || checkClass(2,5,8,playerSign) || checkClass(3,6,9,playerSign) || checkClass(1,5,9,playerSign) || checkClass(3,5,7,playerSign)){
        ...
        wonText.innerHTML = `Jogador <i class="${playerSign}"></i> Ganhou!`;
